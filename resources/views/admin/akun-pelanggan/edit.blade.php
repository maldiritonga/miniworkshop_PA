<x-admin-layout>
    <x-slot name="title">Edit Akun Pelanggan</x-slot>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-[32px] p-8 md:p-12 shadow-sm border border-gray-100">
            <h1 class="text-3xl font-bold text-gray-900 mb-8">Edit Akun Pelanggan</h1>

            <form action="{{ route('admin.akun-pelanggan.update', $pelanggan->id_user) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" required value="{{ old('nama', $pelanggan->nama) }}"
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" required value="{{ old('email', $pelanggan->email) }}"
                               class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-yellow-400 transition-all outline-none text-gray-900 placeholder-gray-400"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="no_hp" id="no_hp" required value="{{ old('no_hp', $pelanggan->no_hp) }}"
                               class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-yellow-400 transition-all outline-none text-gray-900 placeholder-gray-400"
                ...
                <div class="bg-blue-50 p-6 rounded-2xl space-y-4">
                    <h3 class="text-sm font-bold text-blue-800">Ubah Password (Opsional)</h3>
                    <p class="text-xs text-blue-700">Kosongkan jika tidak ingin mengubah password.</p>
